            ...
            { user ?(
                ...
                <>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                ) : type === 'sign-in' ? 'Ingresar' : 'Registrar'}
                                </Button>
                            </div>
                    ...
                    <footer className='flex justify-center gap-1'>
                        <p className='text-14 font-normal text-gray-600'>{type === 'sign-in' ? 'Aún no tengo cuenta?' : 'Ya tengo mi cuenta!'}</p>
                        <Link href={type === 'sign-in' ? '/sign-up' : 'sign-in'} className='form-link'>{type === 'sign-in' ? 'Registrarme' : 'Ingresar'}</Link>
                    </footer>
                </>
            )}
        </section>
